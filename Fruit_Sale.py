...
for value in list(range(50, int(800))):
...
my_layout = {
    'title': f'How much money made per person',
    'title_x': 0.5,
    'xaxis': {
        'title': 'Amount of cash made',
        'titlefont': {'size': 24},
        'tickfont': {'size': 14},
    },
    'yaxis': {
        'title': 'amount of people sold that amount',
        'titlefont': {'size': 24},
        'tickfont': {'size': 14},
    },
}
